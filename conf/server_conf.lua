...
server.intermission_time = 27000
...
server.admin_domains = {}            -- Domain for admin
...
server.server_auth_domain = "tbmc"         -- Domain allowing it's users to be always able to connect (server full, private, ban…)
...
--server.module("gamemode/rugby")                                   -- Allows passing of the flag between mates in ctf modes. Not tested for ihold/protect.
--server.module("pushmod")
