...
mapbattle_vote = "%{red}>>> %{white}Vote for map %{blue}%{map1}%{white}, %{blue}%{map2} %{white}or %{blue}%{map3} %{white}with %{green}1%{white},%{green}2 %{white}or %{green}3",
...
givemaster_message = "%{red}>>> %{blue}%name has passed master privilege to you.",

command_error_message = "%{red}>>> ERROR%{white}: %{orange}Command Error%{white}: %{red}",
command_syntax_message = "%{red}>>> ERROR%{white}: %{orange}Command syntax error%{white}: %{red}%{err} ",
command_not_found_message = "%{red}>>> ERROR%{white}: %{orange}Command not found",
command_disabled_message = "%{red}>>> ERROR%{white}: %{orange}Command disabled",
command_permission_denied_message = "%{red}>>> ERROR%{white}: %{orange}Permission, Denied",
command_internal_error_message = "%{red}>>> ERROR%{white}: %{orange}Internal Error",

specmsg_command_message = "%{red}>>> %{blue}spec-msg %{name}%{magenta}(%{cn})%{white}: %{green}%{text}",
